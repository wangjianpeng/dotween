...
public class StringsBrain : BrainBase
{
	...
	void Start()
	{
		...
		// String scramble
		DOTween.To(()=> stringToTween3, x=> stringToTween3 = x, "Hello I'm a new string!", 1.5f)
			// .SetOptions(true)
			.SetEase(EaseType.InOutQuad).SetLoops(-1, LoopType.Yoyo).Pause();
		DOTween.To(()=> stringToTween4, x=> stringToTween4 = x, "Hello I'm a new string!", 1.5f)
			// .SetOptions(true)
			.SetEase(EaseType.InOutQuad).SetLoops(-1, LoopType.Yoyo).Pause();
		DOTween.To(()=> stringToTween5, x=> stringToTween5 = x, "Hello I'm a new string!", 1.5f)
			// .SetOptions(true)
			.SetRelative().SetEase(EaseType.InOutQuad).SetLoops(-1, LoopType.Yoyo).Pause();
